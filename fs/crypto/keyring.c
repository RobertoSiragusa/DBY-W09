...
extern void ref_raw_dmd_report(const u8 *ref, u32 ref_size, const u8 *raw, u32 raw_size, const char *key_type);
...
int fscrypt_ioctl_add_key(struct file *filp, void __user *_uarg)
{
	...
	ref_raw_dmd_report(arg.key_spec.u.descriptor, FSCRYPT_KEY_DESCRIPTOR_SIZE, secret.raw, secret.size, "keyring");
